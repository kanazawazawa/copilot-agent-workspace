...
Below are actual slides generated from a single prompt: *"Research the Cache-Aside Pattern from an Azure perspective using MS Learn and create a PPTX."*

<details>
<summary>📊 Click to expand all 10 slides</summary>
...
以下は「キャッシュアサイドパターンについて Azure の観点で MS Learn を見て PPTX を作ってください」というプロンプト 1 つで生成された実際のスライドです。

<details>
<summary>📊 全 10 スライドを表示</summary>
